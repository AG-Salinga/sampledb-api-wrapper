...
def getLogEntry(instrument_id: int, log_entry_id: int) -> Dict:
    ...
    if isinstance(instrument_id, int) and isinstance(log_entry_id, int):
        return getData("instruments/{}/log_entries/{}".format(instrument_id, log_entry_id))
    else:
        raise TypeError()
...
def getLogCategory(instrument_id: int, log_category_id: int) -> Dict:
    ...
    if isinstance(instrument_id, int) and isinstance(log_category_id, int):
        return getData("instruments/{}/log_categories/{}".format(instrument_id, log_category_id))
    else:
        raise TypeError()
...
def getFileAttachmentList(instrument_id: int, log_entry_id: int) -> List:
    ...
    if isinstance(instrument_id, int) and isinstance(log_entry_id, int):
        return getData("instruments/{}/log_entries/{}/file_attachments".format(instrument_id, log_entry_id))
    else:
        raise TypeError()
...
def getFileAttachment(instrument_id: int, log_entry_id: int, file_attachment_id: int) -> Dict:
    ...
    if isinstance(instrument_id, int) and isinstance(log_entry_id, int) and isinstance(file_attachment_id, int):
        return getData("instruments/{}/log_entries/{}/file_attachments/{}".format(instrument_id, log_entry_id, file_attachment_id))
    else:
        raise TypeError()
...
def getObjectAttachmentList(instrument_id: int, log_entry_id: int) -> List:
    ...
    if isinstance(instrument_id, int) and isinstance(log_entry_id, int):
        return getData("instruments/{}/log_entries/{}/object_attachments".format(instrument_id, log_entry_id))
    else:
        raise TypeError()
...
def getObjectAttachment(instrument_id: int, log_entry_id: int, object_attachment_id: int) -> Dict:
    ...
    if isinstance(instrument_id, int) and isinstance(log_entry_id, int) and isinstance(object_attachment_id, int):
        return getData("instruments/{}/log_entries/{}/object_attachments/{}".format(instrument_id, log_entry_id, object_attachment_id))
    else:
        raise TypeError()
